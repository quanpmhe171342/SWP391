                        ...
                        <div class="container-fluid">
                            ...
                            <div class="product-form-container">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="salePrice" name="salePrice" min="0" required>
                                </div>
                                 <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="productName" name="brief" required>
                                    </div>
                                <div class="input-group">
                                        ...
                                        <c:forEach items="${color}" var="c">
                                            <div class="color-section">
                                                <div class="color-group">
                                                    <div>
                                                        <input type="checkbox" id="color-${c.color_id}" name="color" value="${c.color_id}">

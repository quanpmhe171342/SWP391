...
public class ProductCart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cookies != null) {
            ...
            String[] carts = cartData.split("_");
            for (String cart : carts) {
                int id = Integer.parseInt(cart.split(":")[0].trim());
                int quantity = Integer.parseInt(cart.split(":")[1].trim());
                var productVariant = daoProduct.getListProductById(id);
                if (productVariant != null) {
                    productVariant.setQuantity(quantity);
                    productVariant.setOriginalPrice(quantity * productVariant.getOriginalPrice());

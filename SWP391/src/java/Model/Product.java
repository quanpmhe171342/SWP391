...
public class Product {
    ...
    public Product(int ProductID, String ProductName, Double original_Price, Double sale_price, String Product_description, String brief_information, CategoryProduct ct) {
